...
(defun inicializar-cavalo (tabuleiro &optional (coluna 0))
  "Coloca o cavalo na coluna selecionada para a primeira jogada. Caso n�o seja informada a coluna, ele coloca
   na posi��o (0 0). Caso seja fornecida uma coluna inv�lida, ele informa que a coluna � invalida."
  (cond 
...
(defun criar-no(tabuleiro posicao-do-cavalo pontuacao-atual profundidade no-pai &optional(heuristica 0))
  "Fun��o respons�vel para criar um n�.
   Estrutura do n�: Estado do tabuleiro - Posicao atual do cavalo - Pontua�ao obtida - Profundidade (equivale
...
#|-------------------------------------------------- PROBLEMA -----------------------------------------------|#
#|-----------------------------------------------------------------------------------------------------------|#
#| Isto permite que a variavel do problema esteja escondida e n�o seja manipul�vel por qualquer um. As fun��es ficam definidas dentro da closure do problema para essas fun��es conseguirem manipular o problema.|#
(let ((problema nil))
