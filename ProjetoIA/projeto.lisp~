...
(defun menu-problema-selecionado ()
      ...
      (cond ((not (and (numberp escolha) (< escolha 4) (> escolha 0)))
            ...
            (T
             (progn
               ...
               (format t "~% Opção ~a selecionada." escolha)
               (case escolha
                 (1 (progn (format t "~% Abrindo o menu dos algoritmos...: ~% ~%") (menu-algoritmos)))
      ...
      (cond ((not (and (numberp escolha) (< escolha 5) (> escolha 0)))
            ...
            (T
             (progn
               ...
               (format t "~% Opção ~a selecionada." escolha)
               (case escolha
                 (1 (progn (format t "~% Abrindo o menu do algorimto DFS...: ~% ~%") (menu-bfs)))
                 (2 (progn (format t "~% Abrindo o menu do algorimto DFS...: ~% ~%") (menu-dfs)))
                 (3 (progn (format t "~% Abrindo o menu do algorimto A* ...: ~% ~%") (menu-aestrela)))
...
(defun menu-bfs ()
  ...
  (loop
     (progn
      ...
      (format t "~%          +                          BFS                         +")
      (format t "~%          +                                                      +")
      (format t "~%          +                1-Voltar ao Menu Algoritmos           +")
      (format t "~%          +                                                      +")
      (format t "~%          ++++++++++++++++++++++++++++++++++++++++++++++++++++++++")
      (format t "~%~%~% Opção => "))
     (let ((escolha (read)))
            ...
            (T
             (progn
               ...
               (case escolha
                 ...
                 (1 (progn (format t "~% Voltando ao Menu Algoritmos...") (return)))
                 (T (progn (format t "~% Opção Inválida~% Opção => ") (setf escolha (read)))))))))))
